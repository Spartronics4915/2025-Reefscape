...
public class VariableAutos {
    ...
    public enum BranchSide{ //? you could consider bringing the tag offsets back and modifying dynamics
        LEFT(new Translation2d(-0.153209, 0.5406845 + 0.02)), //-0.109236, 0.5406845 + 0.02))
        RIGHT(new Translation2d(0.218062 - 0.0508, 0.5408565 + 0.02)),//0.218918 - 0.0508, 0.5408565 + 0.02))
